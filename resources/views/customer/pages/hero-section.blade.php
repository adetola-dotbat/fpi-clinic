<div class="st-hero-wrap st-gray-bg st-dynamic-bg overflow-hidden st-fixed-bg" data-src="customer/assets/img/hero-bg.jpg">
            ...
            <div class="slick-wrapper">
                <div class="slick-slide-in">
                    <div class="st-hero-img">
                        <img src="customer/assets/img/hero-img.png" alt="Hero img">
                    </div>
                </div>
                <div class="slick-slide-in">
                    <div class="st-hero-img">
                        <img src="customer/assets/img/hero-img1.png" alt="Hero img">
                    </div>
                </div>
                <div class="slick-slide-in">
                    <div class="st-hero-img">
                        <img src="customer/assets/img/hero-img2.png" alt="Hero img">
                    </div>
                </div>
            </div>
        </div><!-- .slick-container -->
    ...
    <div class="st-hero-shape"><img src="customer/assets/img/shape/hero-shape.png" alt="hero shape"></div>
</div>
